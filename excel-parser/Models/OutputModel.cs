public class OuutputModel()
{
    ...
    public string FractionOfWork { get; set; } = string.Empty;
    public string WorkingHolidays { get; set; } = string.Empty;
    public string WorkingAtNight { get; set; } = string.Empty;
    public string TurnWork { get; set; } = string.Empty;
}
